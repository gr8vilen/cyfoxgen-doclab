...
def deploy_container():
    ...
    try:
        ...
        # Get unique IP
        container_ip = network_manager.get_next_ip()
        
        # Configure networking
        networking_config = client.api.create_networking_config({
            network_manager.network_name: client.api.create_endpoint_config(
        ...
        # Update container IP (Docker assigns it)
        container.reload()
        actual_ip = container.attrs['NetworkSettings']['Networks'][network_manager.network_name]['IPAddress']
        ...
        logger.info(f"Deployed container {name} with IP {actual_ip}")
